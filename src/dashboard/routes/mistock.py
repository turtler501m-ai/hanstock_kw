...
MISTOCK_ENV_FIELDS = [
    ...
    {"key": "MISTOCK_MAX_DAILY_ORDERS", "attr": "max_daily_orders", "type": "int", "default": "20"},
...
MISTOCK_STRATEGY_ALIAS = {
    ...
    "MAX_DAILY_ORDERS": "MISTOCK_MAX_DAILY_ORDERS",
...
def mistock_config_api():
    ...
    return {
        **flags,
        ...
        "max_daily_orders": mistock_config.max_daily_orders,
